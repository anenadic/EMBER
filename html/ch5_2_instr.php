...
<head>
<title>EMBER: Chapter 5: Sequence property profiles: Instructions Step 2</title>
...
<p><b> </b>Here, we will use different software tools to predict the transmembrane
 topology of your protein.</p>
<p>i) Paste your sequence into the
  <?php $Url_id="97"; $Link_naam="PSIPRED"; include ('get_link.php'); ?> <em>input form</em>, and click on the MEMSAT option (results are emailed
  back to you, so remember to supply your email address). </p>
<p>ii) Alternatively, paste your sequence into the
  <?php $Url_id="92"; $Link_naam="TMpred"; include ('get_link.php'); ?> <em>input form</em>. Compare results from the two programs. </p>
<p><em>Reflections...</em></p>
<ul>
 <li><em>From what you know of your 
  sequence from previous steps, is it a membrane protein? Do the predictions 
  here confirm what you suspect?</em></li>
 <li><em>How do these results differ 
  from the manner in which hydropathy profiles are calculated? (<a href="ch5_info_2.php">HINT</a>)</em></li>
 <li><em>Do the results consistent? 
  If not, what are the differences and how important are they?</em></li>
</ul>
