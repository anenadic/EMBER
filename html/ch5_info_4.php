...
?><blockquote>
 ...
 5.4&nbsp;&nbsp;<u>Tertiary structure prediction</u></blockquote>

<p class="sectionheader">
<a name="_Ref26140"></a>5.4 Tertiary structure prediction  </p>
<p>Reliable tertiary structure 
 prediction (especially using methods that build on secondary predictions, which, 
 in practice, many do) is still beyond our reach. Indeed, the more we learn about 
 the complexity of protein folding, the further the goal appears to recede over 
 the horizon. It is clear that direct prediction of structure from sequence remains 
 decades away. Today, the state of the art for tertiary structure prediction 
 is actually fold recognition, based on known structures. Such methods will be 
 described in more detail in <a href="ch7_aims.php">Chapter 7</a>.
</p>

<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch5_info_3-4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'>&nbsp;</p></td>
