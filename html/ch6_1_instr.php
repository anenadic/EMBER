...
<head>
<title>EMBER: Chapter 6 - Fold classification: Instructions Step 1</title>
...
<table width="750" border="0" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
 ...
 <tr>
<td width="215" height="530" valign="top" nowrap style=" background-image:  url(Graphics/backgrounds/ch6.jpg); background-repeat: no-repeat"></td>
...
?>
<p>Homologues with known 3D structure</p>
<p>In this step, we will seek homologues of known structure.</p>
<p>i) Use your sequence to run BLAST at the
...
<ul>
 <li><em>How 
  many matches were statistically significant?</em></li>
 <li><em>Why 
  are there fewer hits from a BLAST of PDB than from a BLAST of a sequence database?</em></li>
</ul>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
	<tr><td> 
		<p align='left'><a href="JavaScript:goStep('ch5_3')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous_chapter','','Graphics/previous_chapter_f2.gif',1)"><img name="previous_chapter" src="Graphics/previous_chapter.gif" width="85" height="49" border="0" alt=""></a></p></td><td>
