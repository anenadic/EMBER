...
<head>
<title>EMBER: Chapter 8 - Fold recognition/threading: Quiz</title>
...
<table width="750" border="0" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
 ...
 <tr>
  <td width="215" height="530" valign="top" nowrap style=" background-image:  url(Graphics/backgrounds/ch8.jpg); background-repeat: no-repeat"></td>
  ...
  <tr> 
   <td valign="top"> 
    <table border=0 cellspacing=0 cellpadding=0 width="100%" height=21> <tr> 
      <td valign=top height=21><img src="Graphics/tab_quiz_aiiqr.gif" width="314" height=21 border=0 align=bottom usemap="#Map"></td>
      <td valign=top height=21 width="100%"> 
       <table border=0 cellspacing=0 cellpadding=0 width="100%" height="21">
        ...
        <tr> 
         <td valign=top height=1 bgcolor="#993399"><img src="Graphics/spacer.gif" width=1 height=1 border=0 align=bottom></td>
        </tr>
       </table></td>
     </tr>
    </table>
    <table border=0 cellspacing=0 cellpadding=0>
     <tr> 
      <td valign=top width=1 bgcolor="#993399"> 
       <p><img src="Graphics/spacer.gif" width=1 align=bottom></p></td>
      <td valign=top background="Graphics/background_content.gif"> 
       <table border=0 cellspacing=0 cellpadding=10 width="100%">
        <tr> 
          <td valign=top>
<?PHP include "quiz_header.php"; $chapter = 8;include "setup_quiz.php"; ?></td>
        </tr>
       </table></td>
      <td valign=top width=1 bgcolor="#993399"> 
     ...
     <tr> 
      <td valign=top width="1" height=1 bgcolor="#993399"> 
       <p><img src="Graphics/spacer.gif" width=1 height=1 align=bottom></p></td>
      <td valign=top width="100%" height=1 bgcolor="#993399"> 
       <p><img src="Graphics/spacer.gif" width=1 height=1 align=bottom></p></td>
      <td valign=top width="1" height=1 bgcolor="#993399"> 
       <p><img src="Graphics/spacer.gif" width=1 height=1 align=bottom></p></td>
     </tr>
