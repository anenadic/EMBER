...
?>
          <blockquote>
           6.1&nbsp;&nbsp;<u>PDB</u><br>
					 &nbsp;&nbsp;&nbsp;&nbsp;6.1.1&nbsp;&nbsp;<u>Growth of the PDB</u><br>
          ...
          <a name="growth"></a>6.1.1 Growth
            of the PDB         </p>
          <p>Unlike DNA sequencing, protein structure determination
           is not yet a fully automated process. Different
            <?php $Url_id="97"; $Link_naam="techniques"; include ('get_link.php'); ?> have different limitations. In crystrallography, for example, obtaining crystals
 can be difficult; or, having got crystals, finding candidates that will diffract
 well can be problematic. Whatever the technique used, building a robust structural
 model from the raw data is a further time-limiting factor. The rate of submission
 of new structures to the PDB is thus far less than the deposition rate of sequence
 data to the central sequence repositories: <em>e.g</em>., in July 2002, PDB
 contained 16,507 entries, while in June 2002 GenBank contained 17,471,000 sequences
 - see Fig 6.2. Note that both of these figures are highly redundant, so the
 number of unique structures and sequences is very much smaller. </p>
          <table width="80%" align="center" cellspacing="8">
           <tr valign="top">
            <td><a href="javascript:openxlink('ch6/fig6-2.html','left')"><img src="ch6/thumbs/fig6-2.gif" width="150" height="189" border="0" class="imgborder"></a></td>
            <td><p class="photocaption">Fig 6.2. Difference in the
              growth of the number of
sequences in GenBank vs. the number of 3D 
structures in PDB. The graph has been truncated 
at 1994 to keep the curves on the same scale.</p>
          ...
          <table width='100%' border=0 cellspacing=0 cellpadding=6>
           <tr>
            <td>
             <p align='left'><a href="ch6_info.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
            <td>
             <p align='center'>&nbsp;</p></td>
            <td>
             <p align='right'><a href="ch6_info_2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
           </tr>
          </table></td>
        </tr>
       </table></td>
