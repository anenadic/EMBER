...
<blockquote>
 ...
 2.4&nbsp;&nbsp;<u>Dynamic algorithms</u><br>
 2.5&nbsp;&nbsp;<a href="ch2_info_5.php">Similarity searching with BLAST</a><br>
 2.6&nbsp;&nbsp;<a href="ch2_info_6.php">PSI-BLAST</a>
</blockquote>
<p class="sectionheader">
 <a name="dyn"></a>2.4 Dynamic algorithms</p>
<p> This type of algorithm solves a problem by combining solutions to sub-problems 
 that are computed once and saved in a matrix. An optimal final solution is then 
 built by combining the best sub-solutions. Matches in the alignments are scored 
 in an additive fashion (<em>i.e.</em>, the score from the previous residue is added to 
 the score of the current match), according to the substitution matrix used. 
</p>
<p> The two most common dynamic-programming approaches are local (Smith-Waterman) 
 and global alignment (Needleman-Wunch). These differ in the way in which gaps 
 are scored: with the local Smith-Waterman, all gaps are scored as zero; in the 
 global Needleman-Wunch, gaps are penalised cumulatively. </p>
<p> Dynamic algorithms tend to be slower but more accurate than heuristic ones 
 (especially slower in multiple alignments). An illustration of such an algorithm 
 can be found <a href="ch2/AlignmentApplet-1.3/AlignmentApplet.html" target="new">here</a>. 
 <i>NOTE: this requires a current version of a Java-enabled browser.</i> </p>
<div align="center">
 <table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   <td>
    <p align='left'><a href="ch2_info_3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch2_info_5.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table>
</div></td>
        </tr>
