...
?><blockquote>
 ...
 8.2&nbsp;&nbsp;<u>GenTHREADER</u><br>
 &nbsp;&nbsp;&nbsp;&nbsp;8.2.1&nbsp;&nbsp;<a href="ch8_info_2-1.php">GenTHREADER output</a><br>
 8.3&nbsp;&nbsp;<a href="ch8_info_3.php">3D-PSSM</a><br>
 8.4&nbsp;&nbsp;<a href="ch8_info_4.php">Applications of fold recognition</a>
</blockquote>
<p class="sectionheader">
<a name="genthreader"></a>8.2 GenTHREADER</p>
<p>
<?php $Url_id="97"; $Link_naam="GenTHREADER"; include ('get_link.php'); ?> can be applied either to complete translated genomic sequences or to individual 
 protein sequences. It aims to detect superfamily relationships, such as fold 
 similarities that result from common ancestry. It does this by generating sequence-structure 
 alignments using a conventional sequence profile-based approach. The algorithm 
 exploits pairwise potentials (estimated from statistics of atomic proximity or colocalisation) and solvation potentials (estimated 
 from statistics of residue burial). These and various alignment parameters (such 
 as length and score) are used to train a neural net to 
 recognise related from unrelated structures, as illustrated in Fig 8.1.</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch8/fig8-1.html','left')"><img src="ch8/thumbs/fig8-1.gif" width="150" height="113" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 8.1. Schematic representation of
     GenTHREADER's Neural Network Architecture (adapted from Jones, 1999).</p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch8_info.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch8_info_2-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
