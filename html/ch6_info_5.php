...
?>
          <blockquote>
           ...
           6.5&nbsp;&nbsp;<u>EC-&gt;PDB</u><br>
           6.6&nbsp;&nbsp;<a href="ch6_info_6.php">Visualisation of Protein Molecules</a>
          </blockquote>
					
					
          <p class="sectionheader"><a name="ec"></a>6.5 EC-&gt;PDB</p>
          <p>The
  <?php $Url_id="108"; $Link_naam="Enzyme Structures Database"; include ('get_link.php'); ?> (EC-&gt;PDB)
  relates known enzyme structures deposited in the PDB to their
 Enzyme Commission (EC) classification and provides links to the ExPASy
 <?php $Url_id="109"; $Link_naam="ENZYME"; include ('get_link.php'); ?> Data
 Bank. The EC classification comprises the following broad categories:</p>
          <p>E.C.1.-.-.- Oxidoreductases<br>
 E.C.2.-.-.- Transferases<br>
 E.C.3.-.-.- Hydrolases<br>
 E.C.4.-.-.- Lyases<br>
 E.C.5.-.-.- Isomerases<br>
 E.C.6.-.-.- Ligases</p>
<p>Entries also include links to the Kyoto Encyclopedia of Genes and Genomes,
  <?php $Url_id="110"; $Link_naam="KEGG"; include ('get_link.php'); ?> (an effort to computerise current knowledge of molecular and cellular biology
 in terms of interacting genes and molecular pathways), and the Evolutionary Analysis of Metabolism,
 <?php $Url_id="111"; $Link_naam="PUMA2"; include ('get_link.php'); ?>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch6_info_4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch6_info_6.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
        </tr>
       </table></td>
