...
<head>
<title>EMBER: Chapter 4 - Sequence alignment: Instructions Step 2</title>
...
<p>Here, we will familiarise ourselves with one or more alignment editors.</p>
...
<table border="1" cellpadding="1" cellspacing="3" >
 <tr>
  <td></td>
  <td>
   <div align="center"><span class="tableheader"><b>alignment editors</b> </span> </div></td>
  <td width="250">
   <div align="center"><span class="tableheader"><b>platform requirements</b> </span> </div></td>
 </tr>
 <tr>
  <td>
   <div align="center"><span class="tableheader"><b>applications</b> </span></div></td>
  <td valign="top">
   
   <p align="center">
   <?php $Url_id="220"; $Link_naam="Utopia Protein Sequence Analysis Suite"; include ('get_link.php'); ?> </p>
   <p align="center">
    <?php $Url_id="70"; $Link_naam="SeaView"; include ('get_link.php'); ?> </p>
   <p align="center">
    <?php $Url_id="224"; $Link_naam="JalView"; include ('get_link.php'); ?> </p></td>
  <td valign="middle">
   
   <p align="center">Windows/MacOS/Linux</p>
   <p align="center">Windows/MacOS/Linux</p>
   <p align="center">Requires Java Runtime Environment (Windows) or JDK (Linux)</p></td>
 </tr>
 <tr>
  <td height="63">
   <div align="center"><span class="tableheader"><b>Web-based Java applets</b></span> </div></td>
  <td height="63">
   <p align="center">
    <?php $Url_id="224"; $Link_naam="JalView"; include ('get_link.php'); ?> </p></td>
  <td height="63" valign="middle">
   <center>
    <p>Java-enabled browsers</p>
   </center></td>
 </tr>
</table>
<p><em><br>
 Reflections...</em></p>
<ul>
 <li><em>Do the different colour schemes 
