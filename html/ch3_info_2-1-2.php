...
<a name="TOC"></a><blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2.1.1&nbsp;&nbsp;<a href="ch3_info_2-1-1.php">Database
 format</a><br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2.2.2&nbsp;&nbsp;<u>Database
 documentation</u><br>
...
<a name="pdoc"></a><span class="sectionheader">3.2.1.2 Database documentation</span>
</p>
<p>The <a href="ch3/PDOCpopup.htm" target="new">documentation</a> 
 file (PDOC, linked from the PS file (see above)), typically, describes the protein 
 family, lists representative members, and includes bibliographic information. 
 Sometimes, more than one regex or profile encodes the same family&#8212;in such 
 circumstances, both are referenced from the same family documentation file (this 
 is a more efficient (non-redundant) method of information storage for both human 
 and computer user alike). An example is shown in Fig 3.4. </p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch3/fig3-4.html','left')"><img src="ch3/thumbs/fig3-4.gif" width="150" height="187" border="0" class="imgborder"></a></td>
  <td><p class="photocaption"><span class="photocaption">Fig 3.4. A typical
     PDOC entry.</span> </p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch3_info_2-1-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch3_info_2-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
        </tr>
       </table></td>
