...
<blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;4.2.2&nbsp;&nbsp;<a href="ch4_info_2-2.php">IProClass</a><br>
 &nbsp;&nbsp;&nbsp;&nbsp;4.2.3&nbsp;&nbsp;<u>ProDom</u><br>
...
<p class="sectionheader"><a name="r_prodom"></a>4.2.3 ProDom</p>
                                <p> 
                                  <?php $Url_id="66"; $Link_naam="ProDom"; include ('get_link.php'); ?>
                                  is a domain database generated automatically 
                                  from sequences in Swiss-Prot and TrEMBL using 
                                  SCOP domains as the seed. ProDom may be searched 
                                  by means of accession numbers, keywords, and 
                                  so on. The <a href="ch4/prodompopup.htm" target="new">results 
                                  page</a> provides a list of accession numbers; 
                                  individual entries offer graphical representations 
                                  of domain architecture, family trees, alignment 
                                  downloads, <em>etc.</em></p>
                                <table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   <td>
    <p align='left'><a href="ch4_info_2-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch4_info_3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table></td>
        </tr>
       </table></td>
