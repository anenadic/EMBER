...
<p class="sectionheader">
 <a name=multiplemot></a><span class="sectionheader">3.4 Multiple Motif Databases</span></p>
<p>There 
 are two main resources that use multiple motifs to characterise protein families, 
 one of which is an essentially unweighted method (based on observed residue 
 frequencies), the other using more sophisticated scoring methods in order to 
 weight residues not observed in the original alignment: these are PRINTS and 
 Blocks.</p>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch3_info_3-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch3_info_4-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
        </tr>
       </table></td>
