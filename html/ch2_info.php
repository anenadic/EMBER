...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
   <td valign="top"> 
	...
	?>
<blockquote>
 2.1&nbsp;&nbsp;<u>The amino acid codes and their properties</u><br>
 ...
 2.6&nbsp;&nbsp;<a href="ch2_info_6.php">PSI-BLAST</a></blockquote>
<p class="sectionheader">
<a name="_Ref1382323"></a>2.1 The amino acid codes and their 
 properties</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><p><a href="#"><img src="ch2/thumbs/fig2-1.gif" width="150" height="137" border="0" class="imgborder" onClick="MM_openBrWindow('ch2/fig2-1.html','','scrollbars=yes,resizable=yes,width=600,height=600')"></a></p></td>
  <td><p class="photocaption">Fig 2.1. A table of the amino acid codes and
    their properties, accompanied by a widely used colour scheme.</p>
 ...
 <table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   ...
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch2_info_2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table>
</div></td>
        </tr>
