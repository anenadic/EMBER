...
<blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;4.4.2&nbsp;&nbsp;<u>T-COFFEE</u><br>
 &nbsp;&nbsp;&nbsp;&nbsp;4.4.3&nbsp;&nbsp;<a href="ch4_info_4-3.php">DIALIGN</a></blockquote>




<p class="sectionheader"><a name="_Ref151998"></a>4.4.2 T-COFFEE</p>
<p> 
<?php $Url_id="71"; $Link_naam="T-COFFEE"; include ('get_link.php'); ?> is a multiple sequence alignment package that allows the combination of a collection 
 of multiple/pairwise, global or local alignments into a single model. It also 
 allows estimation of the level of consistency of each position in the new alignment 
 with the rest of the alignments. A strength of T-COFFEE's strengths is that 
 it copes better with large gaps than does CLUSTAL. An alignment output from 
 the EMBnet T-COFFEE server is shown in Fig 4.8. This is the same one used in 
 the CLUSTALW example, but the result shows subtle differences, as different 
 algorithms invariably make different gap choices. </p>
<table width="80%" align="center" cellspacing="8">
<tr valign="top">
                                <td><a href="javascript:openxlink('ch4/fig4-8.html','left')"><img src="ch4/thumbs/fig4-8.gif" width="150" height="175" border="0" class="imgborder"></a></td>
                                <td><p class="photocaption"><span class="photocaption">Fig
                                   4.8. Results
                                   of a T-COFFEE
                                   alignment
                                   (using
                ...
                <tr>
                 <td>
                  <p align='left'><a href="ch4_info_4-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
                 <td>
                  <p align='center'>&nbsp;</p></td>
                 <td>
                  <p align='right'><a href="ch4_info_4-3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
                </tr>
               </table></td>
        </tr>
       </table></td>
