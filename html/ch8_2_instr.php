...
<body bgcolor="#9dafd1" background="Graphics/background_left.jpg" onLoad="MM_preloadImages('Graphics/banner_top_r2_c2_f2.jpg','Graphics/next_chapter_f2.gif','Graphics/previous_f2.gif')">
<?PHP
	include "notepad.php";
	?>
...
<p>Here again, the aim is to find a 
 3D fold compatible with your sequence.</p>
<p>i) Visit the 
<?php $Url_id="136"; $Link_naam="3D-PSSM"; include ('get_link.php'); ?> home page. Follow the link to <em>Recognise a Fold</em>, enter your e-mail address 
 and upload your sequence - results are emailed back to you. <em>NOTE: If your sequence is longer than 800 residues, you should consult the 3D-PSSM help page.
 The results may take some time...</em></p>
<p>ii) Examine the results and investigate 
 the matches by visiting the 
...
<ul>
 ...
 <li><i>How significant 
  is the prediction? </i></li>
</ul>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
	<tr><td> 
		...
		<div align="center"><form><input type="button" class="formbutton" name="goquiz" value="Go to quiz" onClick="goQuiz(8)" onMouseOver="this.style.background='white'; this.style.color='#990000';" onMouseOut="this.style.background='#D5E1ED'; this.style.color='#000060';"></form></div></td><td>
