...
<blockquote>
 ...
 1.2&nbsp;&nbsp;<u>Exact pattern matching</u><br>
...
<a name="_Ref1364229"></a>1.2 Exact pattern matching</p>
             <p>Exact pattern matching is a process that seeks to identify elements of sequence 
              that precisely match a query, without the need 
              to insert gaps.</p>
             <p>In this exercise, we have used a 'toy' example to show how this technique can be used
              to identify correct reading frames. In reality, we would try to avoid using such short 
              DNA fragments, and would expect to have to take the analysis further - in other words, by performing exhaustive 
              similarity searches of sequence databases; this is 
              the subject of the next chapter. </p>
             <div align="center">
              <table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   <td>
    <p align='left'><a href="ch1_info.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch1_info_3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table>
</div></td>
        </tr>
