...
<p>When viewing the 
 INFBPHPHTASE signature, click on <em>view relations.</em> This shows that the 
 F16P and the INPP signatures are subfamilies of the INPP/F16P family. </p>
<p>ii) Go back to the PRINTS homepage and scan the sequence of 
 F16P_HUMAN by following the link to the <em>NEW FingerPRINTScan</em> package 
 (under <i>PRINTS search</i>) and then <em>FPScan</em>. Write down the e-values 
 of the highest scoring fingerprints. </p>
<p><i>NOTE: the program accepts SWISS-PROT sequence identifiers</i>. 
 </p>
