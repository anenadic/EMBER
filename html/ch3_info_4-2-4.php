...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.4.2.4&nbsp;&nbsp;<u>Interrogating
PRINTS</u><br>
 3.5&nbsp;&nbsp;<a href="ch3_info_5.php">InterPro</a>
</blockquote>
<p class="sectionheader">
 <a name=8></a>3.4.2.4 Interrogating PRINTS</p>
<p>PRINTS 
 may be interrogated in a variety of ways: <i>e.g</i>., via keyword searching
 of 
 <?php $Url_id="60"; $Link_naam="database code"; include ('get_link.php'); ?>, 
<?php $Url_id="61"; $Link_naam="PRINTS code"; include ('get_link.php'); ?>, <i>etc</i>.&#8212;the
information returned in the output from such queries may be modified by changing
the Qualifier switch provided. 
 To build more complex, perhaps more useful, queries, simple keyword searches
 can be combined using the logical operator functions provided by PRINTS's&#8212;the
 type of queries to be combined may be specified using the Function switch provided.
</p>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch3_info_4-2-3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch3_info_5.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
        </tr>
       </table></td>
