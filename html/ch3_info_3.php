...
<a name="TOC"></a><blockquote>
 ...
 3.3&nbsp;&nbsp;<u>Domain-based databases</u><br>
  &nbsp;&nbsp;&nbsp;&nbsp;3.3.1&nbsp;&nbsp;<a href="ch3_info_3-1.php">The Profile
  library</a><br>
...
<p class="sectionheader">
 <a name="dbd"></a><span class="sectionheader">3.3 Domain-based databases</span></p>
<p>There 
 are two main resources that use domain-based approaches for family characterisation, 
 one of which exploits profiles, the other using hidden Markov models: these 
 are the Profile library and Pfam. </p>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   <td>
    <p align='left'><a href="ch3_info_2-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch3_info_3-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table></td>
        </tr>
       </table></td>
