...
<head>
<title>EMBER: Chapter 10 - Investigating the human genome: Instructions Step 3</title>
...
<p>Here, to assess the reliability of the predicted ORFs, we will run BLAST on the results 
 from GeneMark and GENSCAN. </p>
i) Visit the <?php $Url_id="116"; $Link_naam="BLAST"; include ('get_link.php'); ?> submission
page at the EBI, and paste in the ORF from GeneMark. 
<p>ii) Select 100 for <em>Scores 
 and Alignments</em>.</p>
<p>iii) Run BLAST and examine the results. Investigate the matches via the hyperlinks.</p>
<p>iv) Repeat this process for the GENSCAN ORF.&nbsp;</p>
<p><em>Reflections...</em></p>
<ul>
 <li><em>What are the suggested functions of the predicted ORFs?</em></li>
 <li><em>Which 
 of the two predicted ORFs seems to be giving better BLAST results? Why might 
 this be so? </em></li>
 <li><em>With 
 GENSCAN, does any ORF consistently only get matched to half its sequence? What 
 could this mean in terms of exon/intron prediction?</em></li>
</ul>
