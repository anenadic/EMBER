...
?><blockquote>
 ...
 5.2&nbsp;&nbsp;<u>Transmembrane helix prediction</u><br>
 &nbsp;&nbsp;&nbsp;&nbsp;5.2.1&nbsp;&nbsp;<u>MEMSAT</u><br>
 &nbsp;&nbsp;&nbsp;&nbsp;5.2.2&nbsp;&nbsp;<a href="ch5_info_2-2.php">TMpred</a><br>
...
<p class="sectionheader">
 <a name="rmemsat"></a>5.2.1 MEMSAT</p>
<p>MEMSAT exploits known structures 
 of membrane proteins. It employs a set of statistical tables compiled from
 well-characterised structures, and a novel dynamic programming algorithm to
 recognise topology 
 models. The statistical tables illustrate biases of particular amino acids
 to occupy the inside, middle and outside of a membrane.Users should note,
 however, 
 that the dataset used by MEMSAT is small and may not be representative of all
  membrane proteins. A typical output is shown in Fig 5.3.</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch5/fig5-3.html','left')"><img src="ch5/thumbs/fig5-3.gif" width="150" height="191" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 5.3. MEMSAT prediction for OPSD_SHEEP.</p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch5_info_2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch5_info_2-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
