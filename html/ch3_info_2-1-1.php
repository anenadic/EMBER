...
<a name="TOC"></a><blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2.1.1&nbsp;&nbsp;<u>Database format</u><br>
...
<p class="sectionheader">
 <a name=entries></a><a name=9></a><span class="sectionheader">3.2.1.1 Database
  format</span></p>
<p>The 
 database is organised in separate files. The regexs for a given family are deposited 
 with a specific family identifier and an accession number (which takes the form 
 PS#####), together with statistical information (Numerical Results (NR)), lists 
 of matched sequences, links to 3D structure databases, links to associated PDOC 
 entries, and much more. Descriptions of the protein families (usually referred 
 to generically as 'annotation') are stored in documentation files, each of which 
 also has an accession number (which takes the form PDOC#####).</p>
<p>The
 <?php $Url_id="46"; $Link_naam="Numerical Result"; include ('get_link.php'); ?> 
 (see Fig 3.3) contain information relating to 
 the diagnostic performance of the regexs in a given version of the source database 
 (SWISS-PROT). Listed <a href="ch3/regexppopup.htm" target="new">here</a> are the 
 number of true positive, false positive and false negative hits returned from 
 the SWISS-PROT search, as well as calculated precision and recall values (see 
 below). The actual sequences that fall into these categories are detailed in 
 the <a href="ch3/prositeentrypopup.htm"

target=new>database cross reference</a> section.</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch3/fig3-3.html','left')"><img src="ch3/thumbs/fig3-3.gif" width="150" height="110" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 3.3. Typical PROSITE regex entry</p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch3_info_2-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch3_info_2-1-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
        </tr>
       </table></td>
