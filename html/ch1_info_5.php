...
<blockquote>
 ...
 1.5&nbsp;&nbsp;<u>The Swiss-Prot entry format</u> <br>
 1.6&nbsp;&nbsp;<a href="ch1_info_6.php">The FastA sequence format</a>
</blockquote>
<p class="sectionheader">
<a name="lastalsast"></a>1.5 The Swiss-Prot entry format</p>
             <p>The Swiss-Prot format has several fields, including one for the sequence itself - the 
 'SQ' field (see Fig. 1.3). It is possible to download Swiss-Prot sequences in a computer-friendly 
 FastA format directly from their entries in UniProtKB via the 'Format' tab. </p>
             <table width="80%" align="center" cellspacing="8">
              <tr valign="top">
               <td><a href="javascript:openxlink('ch1/fig1-3.html','left')"><img src="ch1/thumbs/fig1-3.gif" width="150" height="66" border="0" class="imgborder"></a></td>
               <td><p class="photocaption">Fig 1.3. The SQ field
                 of a Swiss-Prot entry.</p>
                 <p class="small">[click thumbnail for full
                  size image]</p></td>
              </tr>
             </table> 
<br>
<div align="center">
 <table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   <td>
    <p align='left'><a href="ch1_info_4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch1_info_6.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table>
</div></td>
        </tr>
