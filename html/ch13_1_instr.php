...
<head>
<title>EMBER: Chapter 13 - Investigating sickle cell haemoglobin: Instructions Step 1</title>
...
?>
<p> Here we will retrieve 
 the sickle cell beta globin DNA sequence. </p>
<p>i) Visit the
 <?php $Url_id="191"; $Link_naam="EBI"; include ('get_link.php'); ?> home page and select the <em>SRS Start Session</em>. From the top of the page, select <em>Library Page</em> tab. In the <em>Available Databanks</em> section, select EMBL and click on the <em>Standard Query Form</em> button. Select <em>Description</em> from the pull down menu associated with 
 the first search field, and type in the keywords:</p>
<p align="center">sickle &amp; cell</p>
<p>then click on the <em>Search</em> button.</p>
<p>ii) Examine the results and click on the hit described as <em>&quot;Human sickle cell beta-globin mRNA, 
 complete cds&quot;</em>, to take you to the corresponding EMBL entry. Consult 
 the DE line and confirm that this entry matched your keywords.</p>
<p><em>NOTE: Boolean operators 
 (BUT NOT !, AND &amp;, OR |) can be used in SRS searches to filter results for 
 more efficient searching. </em></p>
<p><em>Reflections...</em></p>
<ul>
 <li><em>What do N and Y represent in a DNA sequence in an EMBL entry?</em></ul>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
	<tr><td> 
		<p align='left'><a href="JavaScript:goStep('ch12_5')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous_chapter','','Graphics/previous_chapter_f2.gif',1)"><img name="previous_chapter" src="Graphics/previous_chapter.gif" width="85" height="49" border="0" alt=""></a></p></td><td>
