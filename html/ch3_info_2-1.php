...
<p class="sectionheader"><a name=1></a>3.2.1 PROSITE</p>
<p><?php $Url_id="44"; $Link_naam="PROSITE"; include ('get_link.php'); ?> was the first protein family database to be derived. Today, it stores three 
 types of information: family-specific regexs (sometimes simply termed 'patterns'); 
 non-family-specific regexs (sometimes termed rules); and profiles.</p>
<p>Regexs are consensus strings 
 (typically 10-30 characters in length) 
 <?php $Url_id="45"; $Link_naam="derived"; include ('get_link.php'); ?>
 from conserved motifs in sequence alignments. Diagnostically, they are effective
  for many families, but reach their limits when evolutionary relationships
 are 
 distant&#8212;in such circumstances, they tend to identify many false matches and
  often miss true ones. A typical family-specific regex is illustrated in Fig
 

3.1.</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch3/fig3-1.html','left')"><img src="ch3/thumbs/fig3-1.gif" width="150" height="31" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 3.1. Typical family-specific regex.</p>
    <p class="small">[click thumbnail for full size image]</p></td>
 </tr>
</table>
<p>Rules, which are typically 
 only 3 or 4 residues long, are even less stringent&#8212;they are used to identify 
 potential functional sites, such as glycosylation and phosphorylation sites,&nbsp;but 
 matches to them are not necessarily significant. A typical rule is illustrated 
 in Fig 3.2.</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch3/fig3-2.html','left')"><img src="ch3/thumbs/fig3-2.gif" width="150" height="38" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 3.2. Typical non-family-specific rules for
    glycosylation- and phosphorylation-sites.</p>
    <p class="small">[click thumbnail for full size image]</p></td>
 </tr>
</table>
<br>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch3_info_2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch3_info_2-1-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
