...
<head>
<title>EMBER: Chapter 13 - Investigating sickle cell haemoglobin: Instructions Step 5</title>
...
?>
<p>It is important to search the literature and other resources to reinforce any observations made 
 in the previous steps and gather further useful information.</p>
<p>i) Click on the <em>Library Page</em> tab of your current SRS page to return to 
 the SRS database selection page. Select <em>MIM</em> (a database of genetic 
 mutations that cause human disease) by checking the button next to MIM in the <em>Literature, Bibliography and Reference Databases</em>. Click on the <em>Standard Query Form</em> button and in the generated form change the search type of the first query field from <em>AllText</em> to <em>Keywords</em> and enter the search 
 term:</p>
<p align="center">sickle cell anemia</p>
Click the <em>Search</em> button, which will return a list of MIM entries. 
<p><em> NOTE: Keywords is one of the few fields searchable with more than one 
 word. Anemia is the American spelling. </em></p>
<p>ii) Choose the result whose description (phenotype) is exactly &quot;SICKLE 
 CELL ANEMIA&quot; and read its MIM entry. Click on the link to the allele corresponding 
 to the most common cause of sickle cell anaemia and examine the entry. </p>
<p><em>Reflections...</em></p>
<ul>
 <li><em>What is the mutation that 
  most commonly causes sickle cell anaemia and what is its OMIMALLELE entry 
  number?</em></li>
 <li><em>Why do you think 
  some of the restriction enzymes mentioned in the OMIMALLELE entry were not 
  included in your restriction map? </em>
</ul>
