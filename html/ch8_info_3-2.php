...
<blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;8.3.2&nbsp;&nbsp;<u>3D-PSSM output</u><br>
 8.4&nbsp;&nbsp;<a href="ch8_info_4.php">Applications of fold recognition</a>
</blockquote>
<p class="sectionheader">
 <a name="r3d_output" id="r3d_output"></a>8.3.2 3D-PSSM 
 output</p>
<p>An example of the results 
 returned from 3D-PSSM is illustrated in Fig 8.3. For 
 each matched structure, match statistics are output in tabular form. PDB ID 
 codes are provided, together with a code indicating which domains have been 
 matched by the query. Pairwise sequence alignments, annotated with secondary 
 structural elements of the matched structures, provide a visual representation 
 of the quality of each match. These can be used in concert E-values 
 shaded to reflect their estimated confidence level (see 
 Fig 8.3A) to help ascertain which is the best match.</p>
<p>A
 system, Biotext is used for matching and scoring 
 functional keywords associated with the query protein sequence and fold library 
 structures.</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch8/fig8-3.html','left')"><img src="ch8/thumbs/fig8-3.gif" width="150" height="151" border="0" class="imgborder"></a></td>
  <td><p class="photocaption"><strong>Fig 8.3. 3D-PSSM output. </strong></p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch8_info_3-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch8_info_4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
