...
<blockquote>
 ...
 7.2&nbsp;&nbsp;<a href="ch7_info_2.php">SWISS-MODEL </a><br>
 7.3&nbsp;&nbsp;<u>Geno3D</u><br>
 7.4&nbsp;&nbsp;<a href="ch7_info_4.php">Application of homology models</a>
</blockquote>
<p class="sectionheader"><a name="Geno3d"></a>7.3 Geno3D</p>
<p>
<?php $Url_id="121"; $Link_naam="Geno3D"; include ('get_link.php'); ?> is another Web server for automatic molecular modelling. Like SWISS-MODEL, it 
 accepts a query sequence and performs the modelling in successive steps: </p>
<ol>
 <li>identify homologues 
  with known 3D structure using PSI-BLAST</li>
 <li>provide potential templates 
  for model building</li>
 <li>perform alignment of 
  query and template sequences</li>
 <li>extract geometrical 
  restraints (dihedral angles and distances) for corresponding atoms between 
  query and template</li>
 <li>perform 3D construction 
  using a distance geometry approach </li>
 <li> e-mail results to user</li>
</ol>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch7_info_2-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch7_info_4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
        </tr>
       </table></td>
