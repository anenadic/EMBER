...
?><blockquote>
 ...
 8.4&nbsp;&nbsp;<u>Applications of fold recognition</u>
</blockquote>
<p class="sectionheader"><a name="rfold"></a>8.4 Applications 
 of fold recognition</p>
<p>Fold recognition uses a 
 combination of advanced pattern matching techniques to &quot;predict&quot; the
  structures of unknown query sequences using libraries of known folds. Its
 most 
 useful areas of application lie within the Twilight Zone (where sequence comparison
  algorithms struggle to identify remote relationships) and in the Midnight
 Zone 
 (where such algorithms fail completely to detect structural similarities).
 Attempts to develop the best fold recognition method have been highly competitive.
 In 
 fact, since 1994, a biannual competition, 
<?php $Url_id="135"; $Link_naam="CASP"; include ('get_link.php'); ?> (Critical Assessment of protein Structure Prediction), has been held to assess
  the success of different protein structure prediction methods. In 
 a review of CASP3, Sternberg emphasised that alignment accuracy is critical
  to obtaining accurate models. The use of profiles, able to better detect and
 
 help better align distantly related sequences, was seen as an important development
  (Sternberg, 1999). Of course, the quality of predictions often depends on
 the 
 availability of structural templates, as most techniques rely on the existence
  of template databases (Sippl <em>et al.</em>, 2001) in the absence of more
  robust 
 <em>ab initio </em>methods.
</p>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch8_info_3-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'>&nbsp;</p></td>
