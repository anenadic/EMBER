...
<head>
<title>EMBER: Chapter 3 - Protein family analysis: Instructions Step 2</title>
...
<p>i) To identify known domains, paste your ID code (or full sequence) into the
 <?php $Url_id="35"; $Link_naam="Profiles"; include ('get_link.php'); ?> search form. Examine the match details and their statistics - follow the links
...
<ul>
 ...
 <li><i>Are the matches
    significant? How do you judge this? <a href="ch3_info.php#profileresults">(HINT)</a></i></li>
 <li><i>If you retrieved
    no matches, why might this be? <a href="ch3_info_3-1.php">(HINT)</a></i></li>
 <li><i>Can you determine
    the likely function of your sequence from your results? <a href="ch3_info_3-1.php">(HINT)</a> </i></li>
</ul>
<p><i>Pfam</i>:</p>
<ul>
 <li><i>How many matches
    did you retrieve?</i></li>
 <li><i>Are the matches
    significant? How do you judge this? <a href="ch3_info_3-2.php">(HINT)</a></i></li>
 <li><i>Can you determine
    the likely function of your sequence from your results? Do the domains
    matched have a known 3D-structure? </i></li>
</ul>
<p><i>Overall</i>:</p>
<ul>
 <li><i>Are the results
    consistent with the results of searching PROSITE patterns? </i></li>
 <li><i>Is a concensus emerging
    from the different searches? Draw a diagram to indicate the relationship
    between the various matches.</i></li>
</ul>
