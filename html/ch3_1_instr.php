...
<head>
<title>EMBER: Chapter 3 - Protein family analysis: Instructions Step 1</title>
...
i) To locate known 
 sequence patterns (regular expressions), paste the ID code (or full sequence) 
 into the 
 <?php
$Url_id="29"; $Link_naam="ScanProsite";
 include ('get_link.php'); ?> <em>form</em>. Don't forget to click <i>Exclude motifs with a high probability 
 of occurrence</i>, otherwise results are likely to be noisy. 
<p>For each hit, you should find an associated documentation file. 
 Follow the link to examine the family's annotation and regular expression search statistics. </p>
<p><i>Reflections...</i></p>
<i>PROSITE:</i>
 <ul><li><i>How many matches did you retrieve 
  (did you remember to use the filter to exclude frequently occurring motifs? 
  What difference does this make)?</i></li>
 <li><i>Are the matches significant? 
  How do you judge this? (<a href="ch3_info_2-1-1.php">HINT</a></i>)</li>
 <li><i>In the database entry, are any false matches reported? How &quot;good&quot; do you think the regular expression
   is? </i></li>
</ul>
</ul>
<i>Overall:</i>
<li><i>What 
  do the matched patterns that you judge to be genuine tell you about the possible 
  function/s of your sequence</i>?</li>
</ul>

<table width='100%' border=0 cellspacing=0 cellpadding=6>
	<tr><td> 
		<p align='left'><a href="JavaScript:goStep('ch2_2')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous_chapter','','Graphics/previous_chapter_f2.gif',1)"><img name="previous_chapter" src="Graphics/previous_chapter.gif" width="85" height="49" border="0" alt=""></a></p></td><td>
