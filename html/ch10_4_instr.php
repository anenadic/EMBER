...
<head>
<title>EMBER: Chapter 10 - Investigating the human genome: Instructions Step 4</title>
...
<p>Here, to assess the reliability of the predicted ORFs, we will run GeneQuiz on the two longest predicted ORFs from both the GeneMark and GENSCAN results. GeneQuiz uses a variety of search and analysis tools to create a report that includes the predicted protein function, an evaluation of the closest homologue, and 3-D homology models. </p>
<p>i) Visit the
 <?php $Url_id="141"; $Link_naam="GeneQuiz"; include ('get_link.php'); ?> submission page at the EBI. </p>
<p>ii) Follow the <em>GQserve</em> link and paste in your ORFs from the previous step, remembering to provide a sequence name and your email address. </p>
<p>iii) Examine the results. Investigate the matches via the hyperlinks.</p>
<p ><em>Reflections... 
 </em></p>
<ul>
 <li><em>What 
  are the suggested functions of the predicted ORFs?</em></li>
 <li><em>What 
  is the difference between using BLAST and GeneQuiz to analyse an amino acid 
  sequence?</em></li>
 <li><em>From 
  the BLAST and GeneQuiz results, can you say whether GeneMark or GENSCAN was 
  better at identifying ORFs? </em></li>
</ul>
