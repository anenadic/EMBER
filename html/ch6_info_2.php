...
?>
          ...
          <a name="_Ref82707"></a>6.2 PDB Summary</p>
          <p>
           <?php $Url_id="102"; $Link_naam="PDBsum"; include ('get_link.php'); ?> provides summary
 <?php $Url_id="103"; $Link_naam="information "; include ('get_link.php'); ?> for all proteins of known structure. The structure summary includes details
 of <a href="ch6/image1.htm" target="new">resolution and R factor</a>, <a href="ch6/image2.htm" target="new">secondary
 structure</a>, <a href="ch6/image3.htm" target="new">associated ligands</a>, <a href="ch6/image7.htm" target="new">fold
 cartoons</a>, <a href="ch6/image5.htm" target="new">ligand interactions</a>,
 and so on. Brief summaries of the <a href="ch6/image6.htm" target="new">summary</a> information
 are also available for each entry.
</p>
          <table width='100%' border=0 cellspacing=0 cellpadding=6>
           <tr>
            <td>
             <p align='left'><a href="ch6_info_1-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
            <td>
             <p align='center'>&nbsp;</p></td>
            <td>
             <p align='right'><a href="ch6_info_3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
           </tr>
          </table></td>
        </tr>
       </table></td>
