  ...
  <tr> 
   <td valign="top"> 
    <table border=0 cellspacing=0 cellpadding=0 width="100%" height=21> <tr> 
      <td valign=top height=21><img src="Graphics/final_tab.gif" width="314" height=21 border=0 align=bottom></td>
...
<p><img src="Graphics/quiz_header.gif" width="457" height="14"></p>
<?php ;$chapter = 14;include "setup_quiz.php"; ?></td>
        </tr>
       </table></td>
      <td valign=top width=1 bgcolor="#7B0101"> 
     ...
     <tr> 
      <td valign=top width="1" height=1 bgcolor="#7B0101"> 
       <p><img src="Graphics/spacer.gif" width=1 height=1 align=bottom></p></td>
      <td valign=top width="100%" height=1 bgcolor="#7B0101"> 
       <p><img src="Graphics/spacer.gif" width=1 height=1 align=bottom></p></td>
      <td valign=top width="1" height=1 bgcolor="#7B0101"> 
       <p><img src="Graphics/spacer.gif" width=1 height=1 align=bottom></p></td>
     </tr>
...
<script>awmSelectedItem=23</script>
<?PHP
	include "toc.php";
	?><p>&nbsp;</p></body>
</html>
