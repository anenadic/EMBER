...
<head>
<title>EMBER: Chapter 6 - Fold classification: Instructions Step 2</title>
...
<p>Here, we will explore details of your structure from its PDB summary files.</p>
<p>i) Supply the PDB ID code to the 
<?php $Url_id="102"; $Link_naam="PDBsum"; include ('get_link.php'); ?> query form. Examine the entry, including the images provided, the secondary 
 structure elements, any associated ligand(s), the PDB header, and so on. </p>
<p>ii) 
 Alternatively, supply a keyword to the <em>Search string</em> box (<em>e.g</em>., 
 &quot;rhodopsin&quot;). </p>
<p><em>Reflections...</em></p>
<ul>
 <li><em> How 
  do the secondary structure elements shown here compare with the predictions
   from the <a href="ch5_aims.php">previous Chapter</a>? How accurate are the predictions?</em></li>
 <li><em> What 
  information is stored in the PDB header? What is the purpose of having a sequence 
  stored in the header when sequence databases store this information? (<a href="ch6_info.php">HINT</a>) 
  </em></li>
 <li><em><i>Does your protein 
  have an associated ligand? If so, which residues in the sequence interact 
  with the ligand? Referring back to your sequence alignment, are these residues 
  conserved? Would you expect them to be? Do any of them lie in the motifs defined 
  by PROSITE, BLOCKS or PRINTS?</i></em></li>
</ul>
