...
?><blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;5.2.1&nbsp;&nbsp;<a href="ch5_info_2-1.php">MEMSAT</a><br>
...
<a name="_Ref25907"></a>5.2 Transmembrane helix prediction</p>
<p>Though physiochemical properties 
 provide a useful indicator of putative TM helices, these are merely crude predictions. 
 Attempts to incorporate more biological information into such calculations have 
 led to the development of a number of different prediction tools, but all are 
 hampered by the paucity of known membrane protein structures. We will take a 
 closer look at two statistical approaches.
</p>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch5_info_1-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch5_info_2-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
