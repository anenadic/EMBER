...
<head>
<title>EMBER: Chapter 8 - Fold recognition/threading: Instructions Step 1</title>
...
<p> The aim here is to find a 3D fold compatible with your sequence. If the structure of your 
 protein is already known, for the purpose of this exercise, you may wish to 
 use one of these <a href="ch8/sequences.htm" target="left">sequences</a> instead. 
</p>
<p>i) Visit the
 <?php $Url_id="97"; $Link_naam="PSIPRED"; include ('get_link.php'); ?> submission page. Enter your e-mail address and upload your sequence. Select the <em>'Quick'
GenTHREADER fold recognition</em> option and click on <em>Predict </em> - results
will be emailed back to you. <em>NOTE: The results may take some time...</em></p>
<p>ii) Examine the results and investigate the matches by visiting the
  <?php $Url_id="7"; $Link_naam="PDB"; include ('get_link.php'); ?> and
 <?php $Url_id="102"; $Link_naam="PDBsum"; include ('get_link.php'); ?> resources.</p>
<p><i>Reflections... 
</i></p>
<ul>
 <li><i>What is the 
  structure predicted for your sequence?</i></li>
 <li><i>What confidence 
  level is given for this prediction? How does this relate to its statistical 
  significance? (<a href="ch8_info_2-1.php">HINT</a></i>)</li>
</ul>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
	<tr><td> 
		<p align='left'><a href="JavaScript:goStep('ch7_2')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous_chapter','','Graphics/previous_chapter_f2.gif',1)"><img name="previous_chapter" src="Graphics/previous_chapter.gif" width="85" height="49" border="0" alt=""></a></p></td><td>
 ...
 <map name="Map">
  ...
  <area shape="rect" coords="234,4,296,17" href="ch8_refs.php" alt="References" title="References">
 </map>
 

</div><script>awmSelectedItem=13</script>
<?PHP
	include "toc.php";
	?><p>&nbsp;</p></body>
</html>
