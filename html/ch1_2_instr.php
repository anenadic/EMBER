...
<head>
<title>EMBER: Chapter 1 - Sequence translation & identification: Instructions Step 2</title>
...
<p>From now on, it is necessary to work with several windows. </p>
<p>i) Click 
 <?php
$Url_id="1"; $Link_naam="here";
 include ('get_link.php'); ?> to access the ExPASy translator and paste your fragment
 into the <em>input box</em> 
 (if you've stored the sequence in your notepad, you may need to re-select it). </p>
<p>ii) 
 Press <em>TRANSLATE SEQUENCE</em> to view the translations. 
 </p>
<p><i>Reflections...</i></p>
<ul>
 <li><i>How many of the translations contain stop codons? 
  (<u><a href="ch1_info.php">HINT</a></u>)</i></li>
</ul>
