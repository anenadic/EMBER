...
?><blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;5.1.2&nbsp;&nbsp;<a href="ch5_info_1-2.php">Physicochemical profiles</a><br>
 5.2&nbsp;&nbsp;<a href="ch5_info_2.php">Transmembrane helix prediction</a><br>
 5.3&nbsp;&nbsp;<a href="ch5_info_3.php">Secondary structure profiles</a><br>
 5.4&nbsp;&nbsp;<a href="ch5_info_4.php">Tertiary structure profiles</a>

</blockquote>

<p class="sectionheader">
<a name="one"></a>5.1 Physiochemical parameters and profiles</p>
<p>From sequence 
 information alone, it is possible to calculate a variety of physicochemical 
 parameters and to depict these in the form of profiles in which the properties 
 of the constituent amino acids are plotted along the length of the sequence.
 </p>
 <table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   ...
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch5_info_1-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table></td>
