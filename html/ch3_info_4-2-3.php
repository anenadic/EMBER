...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.4.2.3&nbsp;&nbsp;<u>Fingerprint
profiles</u><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.4.2.4&nbsp;&nbsp;<a href="ch3_info_4-2-4.php">Interrogating PRINTS</a><br>
 3.5&nbsp;&nbsp;<a href="ch3_info_5.php">InterPro</a>
</blockquote>
<p class="sectionheader">
 <a name=7></a><span class="sectionheader">3.4.2.3 Fingerprint 
   profiles</span></p>
<p>Fingerprint 
 profiles allow rapid visual diagnosis of results returned by FingerPRINTScan. 
 Within a profile, the x-axis denotes the query sequence, the y-axis the percent 
 score for each element of the fingerprint (0-100 per motif); yellow block marks 
 a residue-by-residue match between the query and a particular motif (where the 
 width of the block is the width of the motif and its height the % identity of 
 the match), as shown in Fig 3.11. Even if all motifs are not matched equally 
 well, the pattern of motif formation nevertheless provides a framework for reliable 
 diagnosis. </p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch3/fig3-11.html','left')"><img src="ch3/thumbs/fig3-11.gif" width="150" height="154" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 3.11. Typical fingerprint profile, illustrating
    7 motifs matching the query sequence from N- to C-terminus. This reveals an unequivocal diagnosis of
family membership. </p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch3_info_4-2-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch3_info_4-2-4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
