...
<head>
<title>EMBER: Chapter 7 - Homology modelling: Aims</title>
...
<p>If there is no solved structure 
 for your protein, but there is a structure for a close homologue(s), we can 
 use homology modelling to build a model. Here, we will gain an insight into 
 how to use this technique using two Web-based services. <em>NOTE: Homology modelling 
