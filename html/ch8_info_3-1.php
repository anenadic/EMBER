...
<blockquote>
 ...
 8.3&nbsp;&nbsp;<u>3D-PSSM</u><br>
 &nbsp;&nbsp;&nbsp;&nbsp;8.3.1&nbsp;&nbsp;<u>Searching the fold library</u><br>
 &nbsp;&nbsp;&nbsp;&nbsp;8.3.2&nbsp;&nbsp;<a href="ch8_info_3-2.php">3D-PSSM output</a><br>
 8.4&nbsp;&nbsp;<a href="ch8_info_4.php">Applications of fold recognition</a>
</blockquote>
<p class="sectionheader">
 <a name="3dres"></a>8.3.1 Searching the fold library</p>
<p>For each query sequence, 
 the 3D-PSSM library is scanned using a global dynamic programming algorithm. 
 The score for a match between a residue in the query sequence and a residue 
 in the library sequence is calculated as the sum of secondary structure, solvation 
 potential and PSSM scores. Overall, four steps are performed:</p>
<ol>
 <li>Query sequence is scanned 
  against the Master Protein sequence 
  library using PSI-BLAST, generating a 1D-profile</li>
 <li>Each Master Protein 
  sequence is matched to the query profile</li>
 <li>Query sequence is matched 
  to profiles in the 1D-PSSM library</li>
 <li>Query sequence is matched 
  to profiles in the 3D-PSSM library</li>
</ol>
<p>The final score is the 
 maximum of the scores from these steps, tempered with various gap penalties. 
 An E-value is calculated to reflect the significance of each match.
</p>
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch8_info_3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch8_info_3-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
