...
<head>
<title>EMBER: Chapter 11 - Investigating the inositol phosphatase family: Instructions Step 1</title>
...
<p>Here we will become familiar with documentation and datafiles of the PROSITE database. 
</p>
<p>i) Visit the
 <?php $Url_id="144"; $Link_naam="PROSITE"; include ('get_link.php'); ?> homepage and follow the link to <i>More Details</i>. Take a minute to read the
page. PROSITE houses motifs in
the form of regular expressions and profiles. This section will focus>solely
on the former.</p>
<p>ii) Return to the PROSITE 
 homepage and under <i>Access to PROSITE</i>, search the documentation for entries 
 that include the keyword phosphatase. From the results page, select one of the 
 entries.This will take you to a documentation file. Click on a signature cross-reference 
 at the top of the file to go to the datafile. Study the fields in this file 
 carefully.</p>
	<p>iii) Follow 
 the link <i>View entry in original PROSITE format</i> near the bottom of the 
 page to get the data file as it is actually stored in the database.</p>


<table width='100%' border=0 cellspacing=0 cellpadding=6>
	<tr><td> 
		<p align='left'><a href="JavaScript:goStep('ch10_6')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous_chapter','','Graphics/previous_chapter_f2.gif',1)"><img name="previous_chapter" src="Graphics/previous_chapter.gif" width="85" height="49" border="0" alt=""></a></p></td><td>
