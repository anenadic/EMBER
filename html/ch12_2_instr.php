...
<head>
<title>EMBER: Chapter 12 - Investigating phylogenetic relationships in ABC transporter domains: Instructions Step 2</title>
...
?>
<p>The aim here is to become familiar with different characteristics of the Nod
 protein, using 
 <?php $Url_id="183"; $Link_naam="InterPro"; include ('get_link.php'); ?> (see <a href="ch3_aims.php">Chapter 3</a> for more information about InterPro). </p>
<p>i) Submit one of the TMD 
 sequences to InterPro. Examine the links, especially those to the source databases 
 and those to the P-loop, which is a characteristic of the ABC transporter family. </p>
<p>ii) Repeat this for an NBD sequence. </p>
<p><i>Reflections... </i></p>
<ul>
 <li><i>What are the functional/structural properties of the sequences?</i></li>
 <li><i>Which sequence, the TMD or NBD, contained the P-loop. What is the P-loop? </i></li>
 <li><i>Which sequence generated more hits? </i></li>
</ul>
