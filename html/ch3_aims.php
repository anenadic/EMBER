...
<head>
<title>EMBER: Chapter 3 - Protein Family Analysis: Aims</title>
...
<p>The 
 aim here is to learn about the function of your sequence by searching the protein 
 family databases - these fall into three broad categories depending on their 
 use of single motifs (<em>e.g.</em>, PROSITE), multiple motifs (<em>e.g.,</em> 
 Blocks, PRINTS), or full domain alignments (<em>e.g.,</em> Profiles, Pfam). 
 To obtain a more coherent view of the results, we will also investigate an integrated 
 protein family database - InterPro.</p>
