...
<head>
<title>EMBER: Chapter 10 - Investigating the human genome: Instructions Step 1 </title>
...
?>
 ...
 <p>Here we will extract the sequence of an &quot;unknown&quot; human clone used in the Human Genome Project.<br>
	<em>NOTE: the file 
 is <font color="#FF0000"><strong>BIG</strong> </font>- do not open 
 it in your browser.</em></p>


 <p>i) Visit the Sanger Institute 
<?php $Url_id="138"; $Link_naam="Human Genome Project";  include ('get_link.php'); ?> page, click on <em>Chromosome 6</em>, and go to the <em>finished 
  genomic sequence by ftp</em>. Locate the file for clone dJ377H14 (the file without 
  extension - <font color="#FF0000">not </font>the .embl file) and save 
  the sequence.  </p>
 ...
 <tr>
  <td> 
   ...
   <p>You can also obtain 
    the <a href="ch10/files/dJ377H14.txt" target="new">sequence</a> from EMBER</span></p></td>
 </tr>
</table>

<p >ii) 
 Once downloaded, open the file in a text editor - note that it is in FASTA format. </p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
	<tr><td> 
		<p align='left'><a href="JavaScript:goStep('ch9_1')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous_chapter','','Graphics/previous_chapter_f2.gif',1)"><img name="previous_chapter" src="Graphics/previous_chapter.gif" width="85" height="49" border="0" alt=""></a></p></td><td>
