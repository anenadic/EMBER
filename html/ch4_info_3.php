...
<p class="sectionheader"><a name="editors"></a>4.3 Manual 
   sequence alignment tools</p>
<p>Manual 
 alignment tools allow local alignment construction, manipulation and visualisation. 
 Alignments may be colour coded according to residue property groups, or other 
 characteristics, such as hydrophobicity, helical propensity, <em>etc.</em>. Editors 
 have various features to aid alignment: <em>e.g</em>., some plug-in the automatic 
 alignment program, CLUSTALW; most will plot a representation of some amino acid 
 property scale and/or percentage identity score; and most have the dotplot feature. </p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch4/fig4-2.php','left')"><img src="ch4/thumbs/fig4-2.gif" border="0" class="imgborder"></a></td>
  <td><p class="photocaption"><span class="photocaption">Fig 4.2. Some alignment
     editors and their features.</span></p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch4_info_2-3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch4_info_3-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
        </tr>
       </table></td>
