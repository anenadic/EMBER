...
<head>
<title>EMBER: Chapter 3 - Protein Family Analysis: Quiz</title>
...
<table width="750" border="0" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
 ...
 <tr>
  <td width="215" height="530" valign="top" nowrap style=" background-image:  url(Graphics/backgrounds/ch3.jpg); background-repeat: no-repeat"></td>
...
<?PHP include "quiz_header.php"; $chapter = 3;include "setup_quiz.php"; ?></td>
        </tr>
       </table></td>
      <td valign=top width=1 bgcolor="#993399"> 
