...
<head>
<title>EMBER: Chapter 4: Sequence aligmnent: Aims</title>
...
<p>The aims here are to visualise 
 an alignment of your protein family, to become familiar with different alignment 
 tools and to compare manually- and automatically-generated results. We will 
 use these tools to extract conserved motifs from alignments, and build regular 
 expressions for further database exploration. </p>
