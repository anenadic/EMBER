...
<p class="sectionheader"><a name="_Ref151994"></a>4.4.1
 CLUSTALW</p>
<p>CLUSTALW is one of the most widely used automatic multiple alignment programs. 
 It accepts any number of sequences of any length. All sequence pairs are aligned 
 separately in order to calculate a distance matrix that quantifies the divergence 
 of each pair of sequences. A guide tree is then calculated from the matrix. 
 The sequences are then progressively aligned according to the branching order 
 of the guide tree. An alignment generated automatically using CLUSTALW is shown 
 in Fig 4.7. </p>
															<table width="80%" align="center" cellspacing="8">
                               <tr valign="top">
                                <td><a href="javascript:openxlink('ch4/fig4-7.html','left')"><img src="ch4/thumbs/fig4-7.gif" width="150" height="37" border="0" class="imgborder"></a></td>
                               ...
                               <tr>
                                <td>
                                 <p align='left'><a href="ch4_info_4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
                                <td>
                                 <p align='center'>&nbsp;</p></td>
                                <td>
                                 <p align='right'><a href="ch4_info_4-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
                               </tr>
                              </table></td>
        </tr>
       </table></td>
