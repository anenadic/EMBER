...
<head>
<title>EMBER: Chapter 4 - Sequence alignment: Instructions Step 1</title>
...
<table width="750" border="0" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
 ...
 <tr><td width="215" height="530" valign="top" nowrap style=" background-image:  url(Graphics/backgrounds/ch4.jpg); background-repeat: no-repeat"></td>
...
?>
    ...
    <p>i) To view an alignment of your family, supply the PRINTS ID code
     to the
      <?php $Url_id="63"; $Link_naam="ALIGN"; include ('get_link.php'); ?> query form. This resource allows visualisation of your alignment in plain text
or GIF formats. Choose the GIF option to view your
 alignment in colour.</p>
    <p>ii) You may also retrieve alignments from
 <?php $Url_id="196"; $Link_naam="ProDom"; include ('get_link.php'); ?> by supplying your query sequence in the inbox
 provided.</p>
    <p>iii) Analyse your alignment and pinpoint the areas corresponding to
     the various conserved motifs and domains found by PROSITE, PRINTS,
     Blocks, Pfam and Profiles. Annotate the alignment accordingly.
    <p><em>Reflections... </em><span class="tableheader"></span></p>
<ul>
 <li><em>What, if any, is the structural/functional 
  significance of the locations of these regions?</em></li>
 <li><em>How do the alignments from 
  the different resources differ? And why might this be so?</em></li>
</ul>	  
	...
	<tr><td> 
		<p align='left'><a href="JavaScript:goStep('ch3_4')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous_chapter','','Graphics/previous_chapter_f2.gif',1)"><img name="previous_chapter" src="Graphics/previous_chapter.gif" width="85" height="49" border="0" alt=""></a></p></td><td>
