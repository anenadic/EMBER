...
<a name="rnnpred"></a>5.3.3 NNPREDICT</p>
<p>
<?php $Url_id="94"; $Link_naam="NNPREDICT"; include ('get_link.php'); ?> predicts the secondary structure type for each residue in a sequence. The basis 
 of the prediction is a two-layer, feed-forward neural network, in which the 
 method exploits knowledge of the tertiary class of the protein (either all-&alpha;, 
 all-&beta;, or &alpha;/&beta;). If this information is not known, however, no class 
 need be specified (the default option).</p>
<p>NNPREDICT 
 takes as input a single sequence. Fig 5.7 illustrates a series of outputs from 
 the same query sequence but using different tertiary class options. As can be 
 seen, the specified class dramatically affects the results, and hence this option 
 should only be used when there is good evidence to suggest that the protein 
 is of a specific type. By default, no class is specified (by far the safest 
 option!).</p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch5/fig5-7.html','left')"><img src="ch5/thumbs/fig5-7.gif" width="150" height="111" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 5.7. Output from NNPREDICT, using the same
    query sequence (OPSD_SHEEP), but varying the tertiary structure class
    (H = helix, E = strand, - = no prediction).</p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch5_info_3-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch5_info_3-4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
