...
<a name=log></a>3.4.1.1 Sequence Logos</p>
<p>The information 
 content of blocks is depicted in so-called sequence logos, as shown in Fig 3.8. 
 Within the logo, letter height increases with increasing frequency of the amino 
 acid and with conservation of the position in the motif. The most frequently 
 occurring residues are not only taller but also occupy higher positions in the 
 stack. Sequence weights are calculated using a scoring matrix, in order to reduce 
 the tendency for over-represented sequences to dominate stacks. </p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch3/fig3-8.html','left')"><img src="ch3/thumbs/fig3-8.gif" width="150" height="144" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 3.8. Typical sequence logo illustrating three
    highly <br>
    conserved positions within a 14-residue motif.</p>
...
<div align="center"> <br>
 <table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   <td>
    <p align='left'><a href="ch3_info_4-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch3_info_4-2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table>
 </div></td>
