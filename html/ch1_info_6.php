...
<a name="TOC"></a><blockquote>
 ...
 1.6&nbsp;&nbsp;<u>The FastA sequence format</u> </blockquote>
<p class="sectionheader"><a name="lastalastlast"></a>1.6 The FASTA sequence format</p>
             <p>There are many sequence 
 <?php
$Url_id="13"; $Link_naam="formats";
 include ('get_link.php'); ?>. Most commonly used is the FastA format (see
 Figure 1.4). It comprises an initial header, which starts with a '>' sign, followed
 by some sort of identifier and/or some extra information about the sequence.
 Next is the sequence
  itself, made up of the single-letter code. Several sequences can be stored
 in 
 one FastA file in tandem, each one initialised with a new '>' sign - this format is commonly used for storing multiple sequence alignments. A useful
 program for converting different file formats is 
 <?php
$Url_id="14"; $Link_naam="";
 include ('get_link.php'); ?>.</p>
              <table width="80%" align="center" cellspacing="8">
  <tr valign="top">
   <td><a href="javascript:openxlink('ch1/fig1-4.html','left')"><img src="ch1/thumbs/fig1-4.gif" width="150" height="56" border="0" class="imgborder"></a></td>
   <td><p class="photocaption">Fig 1.4. The sequence of human opsin in FastA format.</p>
...
<br>
 <table width='100%' border=0 cellspacing=0 cellpadding=6 align="center" >
  <tr>
   <td>
    <p align='left'><a href="ch1_info_5.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'>&nbsp;</p></td>
