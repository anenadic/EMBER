...
<blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;4.3.1&nbsp;&nbsp;<a href="ch4_info_3-1.php">Colour schemes</a><br>
 &nbsp;&nbsp;&nbsp;&nbsp;4.3.2&nbsp;&nbsp;<u>Dotplots</u><br>
 4.4&nbsp;&nbsp;<a href="ch4_info_4.php">Automated sequence alignment tools</a>
 </blockquote>
<p class="sectionheader"><br><a name="dot"></a>4.3.2 Dotplots</p>
<p>At the start of the alignment 
 process, similar regions in adjacent sequences may not necessarily lie next 
 to each other and can be hard to spot. Dotplots represent graphically a simple 
 calculation of matches between all the amino acids in two sequences (Fig 4.5). </p>
															<table width="80%" align="center" cellspacing="8">
                               <tr valign="top">
                                <td><a href="javascript:openxlink('ch4/fig4-5.html','left')"><img src="ch4/thumbs/fig4-5.gif" width="150" height="141" border="0" class="imgborder"></a></td>
                                <td><p class="photocaption"><b>Fig
                                   4.5. A
                                   simple
                                   dotplot
                                   of two
                              ...
                              </table><p>They are a useful tool for quickly determining regions of high identity, which 
 form straight lines along, or parallel to, the plot diagonal. The offset from 
 the diagonal gives the number of gaps required to bring similar regions into 
 the correct register, as illustrated in Fig 4.6. </p>
															<table width="80%" align="center" cellspacing="8">
                               <tr valign="top">
                                <td><a href="javascript:openxlink('ch4/fig4-6.html','left')"><img src="ch4/thumbs/fig4-6.gif" width="150" height="127" border="0" class="imgborder"></a></td>
                               ...
                               <tr>
                                <td>
                                 <p align='left'><a href="ch4_info_3-1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
                                <td>
                                 <p align='center'>&nbsp;</p></td>
                                <td>
                                 <p align='right'><a href="ch4_info_4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
                               </tr>
                              </table></td>
        </tr>
       </table></td>
