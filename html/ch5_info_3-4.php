...
?><blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;5.3.4&nbsp;&nbsp;<u>NPS@PBIL consensus secondary structure
 prediction</u><br>
 5.4&nbsp;&nbsp;<a href="ch5_info_4.php">Tertiary structure prediction</a></blockquote>

<p class="sectionheader">
<a name="pbil"></a>5.3.4 NPS@PBIL 
 Consensus Secondary Structure Prediction</p>
<p>The 
<?php $Url_id="95"; $Link_naam="NPS@PBIL"; include ('get_link.php'); ?> server exploits a number of well 
<?php $Url_id="96"; $Link_naam="established techniques"; include ('get_link.php'); ?>
and outputs the predictions in rows, followed by probability 
 values; summary statistics are provided for each method, and a schematic is
generated to illustrate the consensus, as shown in Fig 5.8.
 The result is relatively quick to compute, and visually striking.</p>
 <table width="80%" align="center" cellspacing="8">
  <tr valign="top">
   <td><a href="javascript:openxlink('ch5/fig5-8.html','left')"><img src="ch5/thumbs/fig5-8.gif" width="150" height="126" border="0" class="imgborder"></a></td>
   <td><p class="photocaption">Fig 5.8. PBIL consensus secondary structure
     prediction for OPSD_SHEEP (H=helix, E=extended/&beta; strand and C=coil).</p>
 ...
 <br><table width='100%' border=0 cellspacing=0 cellpadding=6>
  <tr>
   <td>
    <p align='left'><a href="ch5_info_3-3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
   <td>
    <p align='center'>&nbsp;</p></td>
   <td>
    <p align='right'><a href="ch5_info_4.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
  </tr>
 </table></td>
