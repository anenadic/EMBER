...
<blockquote>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;8.2.1&nbsp;&nbsp;<u>GenTHREADER output</u><br>
 8.3&nbsp;&nbsp;<a href="ch8_info_3.php">3D-PSSM</a><br>
 8.4&nbsp;&nbsp;<a href="ch8_info_4.php">Applications of fold recognition</a>
</blockquote>
<p class="sectionheader"><a name="genthreader_output"></a><span>8.2.1 GenTHREADER output</p>
<p>For each matched 
 structure, match statistics are output in tabular form. PDB ID codes are provided, 
 together with a code indicating which domains have been matched by the query. 
 Pairwise sequence alignments, annotated with secondary structural elements of 
 the matched structures, provide a visual representation of the quality of each 
 match. These can be used in concert with the qualitative confidence levels, 
 assigned as HIGH, MEDIUM or LOW (see Fig 8.2A) to help ascertain which is the 
 best match. </p>
<table width="80%" align="center" cellspacing="8">
 <tr valign="top">
  <td><a href="javascript:openxlink('ch8/fig8-2.html','left')"><img src="ch8/thumbs/fig8-2.gif" width="150" height="137" border="0" class="imgborder"></a></td>
  <td><p class="photocaption">Fig 8.2. GenTHREADER output. </p>
...
<table width='100%' border=0 cellspacing=0 cellpadding=6>
 <tr>
  <td>
   <p align='left'><a href="ch8_info_2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('previous','','Graphics/previous_page_f2.gif',1)"><img name="previous" src="Graphics/previous_page.gif" width="85" height="49" border="0" alt=""></a></p></td>
  <td>
   <p align='center'>&nbsp;</p></td>
  <td>
   <p align='right'><a href="ch8_info_3.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','Graphics/next_page_f2.gif',1)"><img name='next' src='Graphics/next_page.gif' width=68 height=49 border=0 alt=''></a></p></td>
 </tr>
</table></td>
